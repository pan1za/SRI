          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="recargo" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Recargo</p>
                  </a>
                </li>
              ...
              <div class="card card-body w-50 offset-3">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date" data-target-input="nearest">
                    <input type="date" name="fechaRecargo" class="form-control datetimepicker-input" required />
                  </div>
                </div>
                ...
                <div class="bootstrap-timepicker">
                  <div class="form-group">
                    ...
                    <div class="input-group date" data-target-input="nearest">
                      <input type="time" name="inicioRecargo" class="form-control datetimepicker-input" required />
                    </div>
                    <!-- /.input group -->
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group date" data-target-input="nearest">
                      <input type="time" name="finalRecargo" class="form-control datetimepicker-input" required />
                    </div>
                  </div>
                  <!-- /.form group -->
                </div>

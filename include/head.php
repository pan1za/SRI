  <?php
    ...
    if ($my_user_type == "admin") {
        $query = mysqli_query($conn, "SELECT u.idUsuario, u.foto, u.nombres, u.apellidos, u.email, u.password, u.username, u.usertype, r.nombre as nombreRestaurante, r.idRestaurante, iu.cargo
                                    from usuario u 
